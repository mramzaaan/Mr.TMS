            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col">
                ...
                <div className="flex-1 overflow-hidden flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-2/3 bg-gray-100 dark:bg-gray-900 p-4 overflow-y-auto flex items-start justify-center">
                        <div ref={contentRef} className="bg-white p-6 rounded-xl shadow-lg w-full max-w-lg mx-auto min-h-[300px]">
                            {/* Header */}
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {schedule.map((s, idx) => (
                                                        <div key={idx} className="bg-gray-50 rounded px-2 py-1 border border-gray-200 flex items-center gap-2 text-sm">
                                                            ...
                                                            <span className="text-gray-500 text-xs truncate max-w-[80px]">{s.subjectName}</span>
                                                        </div>
                                                    ))}
                                                </div>
                                            ) : (
                            ...
                            {/* Footer */}
                            <div className="mt-8 pt-4 border-t border-gray-100 flex justify-between items-center text-[10px] text-gray-400 uppercase tracking-widest">
