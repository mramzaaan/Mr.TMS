        ...
        {navItems.map((item) => {
            ...
            return (
                <button 
                    ...
                    className="relative flex-1 flex flex-col items-center justify-center h-full focus:outline-none group"
                >
                    {isActive && (
                        <motion.div
                    ...
                    <div className={`transition-all duration-300 flex flex-col items-center z-10 ${isActive ? 'scale-110' : ''}`}>
                        ...
                        {showLabels && isActive && (
                            <motion.span 
                                ...
                                exit={{ opacity: 0, y: 5 }}
                                className="text-[9px] font-bold whitespace-nowrap text-white mt-0.5"
                            >
